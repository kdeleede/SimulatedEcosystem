...
public class Wolf : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        AnimalManager.Instance?.AddWolfGenetics(constantSpeed, sensoryDistance, reproductiveUrgeRate);    
    ...
    {
        AnimalManager.Instance?.RemoveWolfGenetics(constantSpeed, sensoryDistance, reproductiveUrgeRate);    
